export const testimonials = [
  {
    ...
    rating: 5,
    description:
      "The attention to detail in every dish was evident, and the staff went above and beyond to ensure we had a wonderful evening.",
  },
  {
    image: "person2.png",
    title: "alex smith",
    rating: 4.5,
    description:
      "Absolutely loved the experience at Gourmet! The food was exceptional, the service was impeccable, and the ambiance was perfect for a special evening out.",
  },
  {
    image: "person3.png",
    title: "olivia cole",
